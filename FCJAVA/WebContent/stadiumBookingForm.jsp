...
<link rel="stylesheet" href="./css/stadiumBooking.css">
<link rel="stylesheet" href="./css/stadiumBookingLayout.css">
<link rel="stylesheet"
 ...
 */
        ...
        map.setCenter(coords);
			...
			<!-- <form action="fcjava.stadium" class="booking_area"> -->
			<form action="fcjava.stadium" class="booking_area" onsubmit="return confirmReservation()">
				...
				<div class="apply_content">
					...
					<input type="hidden" name="b_date" value="<%= request.getParameter("date") %>" />
						...
						<br>
						<%
					List<StadiumDTO> teamNames = (List<StadiumDTO>)request.getAttribute("teamNames");

				            for (int i=0; i< teamNames.size(); i++) {
			            %>
						<input type="radio" name="b_time<%=i%>" > <%=teamNames.get(i).getT_name()%>
						<%}%>
					</div>
