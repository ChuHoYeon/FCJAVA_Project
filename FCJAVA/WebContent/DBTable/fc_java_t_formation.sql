...
CREATE TABLE `t_formation` (
  ...
  `for_name` varchar(10) NOT NULL,
  `pos_num` varchar(10) NOT NULL,
  `pos_name` varchar(10) NOT NULL,
  `pl_num` int(11) NOT NULL,
  KEY `t_num_idx` (`t_num`),
  KEY `pl_num_idx` (`pl_num`),
  CONSTRAINT `pl_num` FOREIGN KEY (`pl_num`) REFERENCES `pl_info` (`pl_num`),
  CONSTRAINT `t_num` FOREIGN KEY (`t_num`) REFERENCES `team_info` (`t_num`)
