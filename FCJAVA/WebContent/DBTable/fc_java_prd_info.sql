...
CREATE TABLE `prd_info` (
  ...
  `prd_memo` varchar(250) DEFAULT NULL,
  `prd_brand` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`prd_no`),
  KEY `prd_info_s_id_idx` (`s_id`),
  CONSTRAINT `prd_info_s_id` FOREIGN KEY (`s_id`) REFERENCES `s_mem_info` (`s_id`)
...
LOCK TABLES `prd_info` WRITE;
/*!40000 ALTER TABLE `prd_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `prd_info` ENABLE KEYS */;
UNLOCK TABLES;
