...
<body>
    ...
    <section class="s_box2">
        ...
        <div class="sum5">
            <div class="list_title1 left1">운동화 (12)
            </div>
        ...
        <ul class="group3">
            <li class="sh2">
                <a href="shop_de.html"><img class="over" src="png/sin_bal/sin_1_1.avif" width="300px" height="300px">
                    <p class="prd_title">Lifestyle Green MONCLER x 아디다스 오리지널스 캠퍼스</p>
                    <p class="shop_price">690,000 원</p>
                </a>
            </li>
            <li class="sh2">
                <a href="shop_de.html"><img class="over" src="png/sin_bal/sin_2_1.avif" width="300px" height="300px">
