...
<%@ page import="com.fcjava.dto.FreeBoardLikeDTO"%>
...
<body>
	...
	<main class="freeBoardMain">
		...
		<div class="sectionBottom">
			<div class="freeBoardSectionBottom">
				...
				<div class="totalBoardCountr">
					<p>총 게시물 <strong><%=totalBoardCount%></strong>건</p>
				</div>
				<ul class="freeBoardList">
					...
					if (totalBoardCount != 0){
										for(FreeBoardDTO freeBoard : freeBoard) {
											...
											out.print("<button type='button' class='btn-favorite' value='"+freeBoard.getNumber()+"'>");
											if(!freeBoardLikes.isEmpty()){
												Boolean res = false;
												for(FreeBoardLikeDTO likes : freeBoardLikes){
													if(likes.getNumber()==freeBoard.getNumber()){
														res =true;
													}
												}
												if (res){
				...
				<div class="wrt-area">
					<div class="wirteBtn">
						<a href="freeBoardWrite.jsp" class="topbtn">글쓰기</a>
					</div>
				</div>
			</div>
		</div>
