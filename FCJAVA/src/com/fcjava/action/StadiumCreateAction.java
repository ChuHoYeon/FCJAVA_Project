...
public class StadiumCreateAction  implements Action{
	private static final StadiumCreateAction instance = new StadiumCreateAction();
	
	private final StadiumService stadiumService = StadiumService.getInstance();

	private StadiumCreateAction() {}

	public static StadiumCreateAction getInstance() {
		return instance;
	}
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return "redirect:fcjava.stadium?page=list";
	}
